...
unsigned int nStakeMaxAge = 7 * 24 * 60 * 60;
...
const string strMessageMagic = "LVGcoin Signed Message:\n";
...
if (pindexBest->nHeight+1 == 1) { nSubsidy = 25000 * COIN; return nSubsidy; }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LVGcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "zondag 11 oktober 2015 755675c0-cdbd-4a31-87c6-ce72d9a1062c";
        CTransaction txNew;
        txNew.nTime = 1444561323;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		uint256 nhashMerkleRoot = uint256("0x9b949f294aaf563f6fae4b2e5988ff64bcbb6783e91a0a8f8a973314da169509");
